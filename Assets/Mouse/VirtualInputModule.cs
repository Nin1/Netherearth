...
namespace UnityEngine.EventSystems
{
    ...
    public class VirtualInputModule : PointerInputModule
    {
        ...
        private GameObject m_pointerOver;
        ...
        [SerializeField]
        private SoftwareMouse m_softwareMouse;
        [SerializeField]
        ...
        public override void UpdateModule()
        {
            ...
            m_MousePosition = SoftwareMouse.GetMousePos();
        }
        ...
        public override void ActivateModule()
        {
            base.ActivateModule();
            m_MousePosition = SoftwareMouse.GetMousePos();
            m_LastMousePosition = SoftwareMouse.GetMousePos();
        ...
        protected void ProcessMouseEvent(int id)
        {
            ...
            // Process pointer exit/enter
            GameObject currentOverGo = leftButtonData.buttonData.pointerCurrentRaycast.gameObject;
            if (currentOverGo != m_pointerOver)
            {
                HandlePointerExitAndEnter(leftButtonData.buttonData, null);
                HandlePointerExitAndEnter(leftButtonData.buttonData, leftButtonData.buttonData.pointerCurrentRaycast.gameObject);
                m_pointerOver = currentOverGo;
            }
        ...
        protected void ProcessMousePress(MouseButtonEventData data)
        {
            ...
            if (data.PressedThisFrame())
            {
                ...
                pointerEvent.position = SoftwareMouse.GetMousePos();
        ...
        protected override MouseState GetMousePointerEventData(int id)
        {
            ...
            /*
            var screenSpaceCursorPosition = RectTransformUtility.WorldToScreenPoint(m_canvasCamera, SoftwareMouse.GetMousePos());

            if (created)
                leftData.position = screenSpaceCursorPosition;
                */

            Vector2 pos = SoftwareMouse.GetMousePos();//screenSpaceCursorPosition;
